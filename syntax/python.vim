...
if !exists("python_79_char_line_limit")
    let python_79_char_line_limit = 1
endif
...
"
syn match pythonError "[!=]= \?\(None\|True\|False\|type\>\|dict\>\|list\>\|tuple\>\|unicode\>\)" display
...
syn cluster pythonExpression    contains=pythonOperator,pythonString,pythonUniString,pythonRawString,pythonUniRawString,pythonNumber,pythonFloat,pythonOctalError,pythonBuiltinObj,pythonBuiltinFunc,pythonError,pythonDecorator,pythonComment,pythonWhiteSpaceError
